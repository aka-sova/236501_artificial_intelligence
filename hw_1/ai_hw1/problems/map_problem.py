...
class MapProblem(GraphProblem):
    ...
    def expand_state_with_costs(self, state_to_expand: GraphProblemState) -> Iterator[OperatorResult]:
        ...
        for outgoing_link in junction.outgoing_links:
            link_successor_state = MapState(outgoing_link.target)
            yield OperatorResult(successor_state=link_successor_state, operator_cost=outgoing_link.distance)  # TODO: remove this line!
    ...
    def is_goal(self, state: GraphProblemState) -> bool:
        ...
        # [Ex.8]: modify the returned value to indicate whether `state` is a final state.
